...
let PropertiesService = class PropertiesService {
    constructor(propertyRepo, bookingRepo) {
    ...
    async getAvailability(propertyId) {
        ...
        const window = { start: property.availableFrom, end: property.availableTo };
        ...
        const bookingRanges = bookings.map((b) => ({ start: b.startDate, end: b.endDate }));
        const gaps = (0, date_utils_1.computeAvailabilityGaps)(window, bookingRanges);
        return {
            propertyId,
